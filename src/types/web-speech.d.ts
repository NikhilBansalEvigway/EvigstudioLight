...
// These are non-standard/experimental and are NOT part of TypeScript's built-in DOM lib, so we
// declare the minimal surface the app uses. Covers Chrome/Edge `webkitSpeechRecognition` too.
